...
```bash
make image=ploa2026.5 relatorios=v0.8.13 execucao=v0.5.27 reest=v0.2.8
```
...
```bash
docker tag volumes:ploa2026.5 aidsplormg/volumes:ploa2026.5
docker push aidsplormg/volumes:ploa2026.5
```
