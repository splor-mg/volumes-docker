...
```bash
make image=ploa2026.4 relatorios=v0.8.07 execucao=v0.5.27 reest=v0.2.8
```
...
```bash
docker tag volumes:ploa2026.4 aidsplormg/volumes:ploa2026.4
docker push aidsplormg/volumes:ploa2026.4
```
