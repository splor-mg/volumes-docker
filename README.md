...
```bash
make image=loa2027.3 relatorios=v0.8.33 execucao=v0.5.28 reest=v0.2.8
```
...
```bash
docker tag volumes:loa2027.3 aidsplormg/volumes:loa2027.3
docker push aidsplormg/volumes:loa2027.3
```
